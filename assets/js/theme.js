  ...
  $(document).ready(function () {
    if (!$(".style-switcher").length) {
      ...
      if (layout == "boxed") {
        $("body.boxed").css({
          "background-image":
            'url("assets/img/patterns/' + pattern + "_" + color + '.png")',
        });
      }
    }
    ...
    jQuery("#subscribe").on("submit", function (e) {
      ...
      jQuery.ajax({
        ...
        success: function (msg) {
          ...
          jQuery("#email1_error")
            .html(msg)
            .removeClass("subscribe-error")
            .removeClass("subscribe-ok")
            .addClass(className);
        },
      });
    });
    ...
    $menu
      ...
      .append(
        '<select class="mobile-menu">' +
          optionsList +
          '</select><div class="mobile-menu-title"><i class="fa fa-bars"></i></div>'
      );
  ...
  return {
    ...
    initIsotope: function () {
      ...
      $(window).resize(function () {
        ...
        $container4.isotope("reLayout", function () {
          addMarker4();
        });
        $.waypoints("refresh");
      });
