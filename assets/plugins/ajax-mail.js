...
$(function () {
  ...
  $("#submit_btn_rf").click(function () {
    ...
    $.ajax({
      ...
      success: function () {
        $("#af-form-rf").prepend(
          '<div class="col-sm-12 "><div class="alert alert-success fade in"><button class="close" data-dismiss="alert" type="button">&times;</button><strong>Your request send!</strong> We will be in touch soon.</div></div>'
        );
        $("#af-form-rf")[0].reset();
      },
    });
